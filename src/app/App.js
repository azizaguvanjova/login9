 ...
 const App = () => {
  return (
    ...
    <div className="absolute flex flex-col justify-start p-10  pt-10  bg-opacity-50 m-40 shadow-[0_2px_10px_rgba(255,255,255,0.2)]">
      <h1 className="text-white/55 text-6xl font-extrabold text-start mb-7 w-[256]">
        LOGIN
      </h1>
      <input
        type="text"
